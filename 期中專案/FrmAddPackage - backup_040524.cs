...
namespace Package2
{
    public partial class FrmAddPackage : Form
    {
		...
		private List<int> pkIndex = new List<int>();
		private Box _tBox;
        public Box tBox
        {
            get
        ...
        private void CoBoxItem()
        {
            ...
            {
				//ComboBoxItem cboItem = new ComboBoxItem(item.BoxID.ToString(), dep.DepName);
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (comboBox1.SelectedIndex == 0)
            {
                ...
                pkIndex.Clear();
				foreach (var box in images)
				{
					pkIndex.Add(box.BoxID);
				}
            ...
            }else if (comboBox1.SelectedIndex == 1)
            {
				...
				pkIndex.Clear();
				foreach (var bag in images)
				{
					pkIndex.Add(bag.BagID);
				}
        ...
        private void button1_Click(object sender, EventArgs e)
        {
          //  MessageBox.Show(comboBox1.SelectedIndex.ToString());
            ...
            if (comboBox1.SelectedIndex == 0 && titleTextBox1.fieldValue != "")
            {
				...
				comboBox1_SelectedIndexChanged("", e);
				// Close();
			}
